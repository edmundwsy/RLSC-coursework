function [f,c,fx,fu,fxx,fxu,fuu,cx,cu,cxx,cxu,cuu] = quadrotor_dyn_cst(x,u,full_DDP)
% combine quadrotor dynamics and cost
% use helper function finite_difference() to compute derivatives

if nargout == 2
    f = quadrotor_dynamics(x,u);
    c = quadrotor_cost(x,u);
else
    ...
    xu_dyn  = @(xu) quadrotor_dynamics(xu(ix,:),xu(iu,:));
    ...
    xu_cost = @(xu) quadrotor_cost(xu(ix,:),xu(iu,:));
